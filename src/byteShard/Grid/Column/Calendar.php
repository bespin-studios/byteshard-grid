...
class Calendar extends CalColumn
{
    ...
    protected Grid\Enum\Type   $dhxTypeRw         = Grid\Enum\Type::CALENDAR;
    protected Grid\Enum\Type   $dhxTypeRo         = Grid\Enum\Type::DATERO;
    protected Grid\Enum\Sort   $sort              = Grid\Enum\Sort::DATE_GERMAN;
    protected Grid\Enum\Align  $align             = Grid\Enum\Align::CENTER;
    protected Grid\Enum\Filter $filter            = Grid\Enum\Filter::TEXT_ADVANCED;//'#date_filter';
